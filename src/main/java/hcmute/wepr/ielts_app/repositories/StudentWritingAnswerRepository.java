...
public interface StudentWritingAnswerRepository extends JpaRepository<StudentWritingAnswer, Integer> {
	...
	List<StudentWritingAnswer> findByWritingExerciseExerciseId(int exerciseId);
	StudentWritingAnswer findWithWritingAnswerCorrectionAndWithWritingExerciseByStudentWritingAnswerId(int answerId);
}
